    ...
    if (id!=null) {
      try {
        ...
        const txData = contract.methods
          .addAsset(id, name, timestamp, value, description, imageURL, notes)
          .encodeABI();
      ...
      >
        ...
        {id && image && typeof image === "string" && (
          <div className="image-preview">
            ...
            <p className="image-note">
              Ảnh hiện tại – bạn có thể chọn ảnh mới để thay thế
            </p>
          </div>
        )}
        ...
        <div className="custom-file-wrapper">
          ...
          <span className="custom-file-name">
            {/* Nếu là file mới đã chọn thì show tên file, ngược lại là link cũ hoặc mặc định */}
